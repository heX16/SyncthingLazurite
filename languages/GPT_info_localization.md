...
### Во всех файлах локализации есть эти индификаторы

`cLanguageName` — название языка на родном языке (включая собственное письмо).

`cLanguageNameEng` — название языка на английском.
